...
src_install() {
    ...
    einfo "creating plugin(s) directory.."
    dodir "/opt/${PN}/plugins/"

    einfo "installing lib(s).."
    dodir "/opt/${PN}/lib/"
    dosym "../../../usr/`get_libdir`/libsoci_core.so" "/opt/${PN}/lib/libsoci_core.so"
    dosym "../../../usr/`get_libdir`/libsoci_sqlite3.so" "/opt/${PN}/lib/libsoci_sqlite3.so"
